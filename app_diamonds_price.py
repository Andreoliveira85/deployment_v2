...
y = st.number_input("Diamond Length (y) in mm:", min_value = 0.1, max_value = 100.0, value = 1.0)
z = st.number_input("Diamond Length (z) in mm:", min_value = 0.1, max_value = 100.0, value = 1.0)
